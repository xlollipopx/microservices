...
},{"cors":"node_modules/cors/lib/index.js"}],"node_modules/axios/lib/helpers/bind.js":[function(require,module,exports) {
'use strict';
...
},{"./lib/axios":"node_modules/axios/lib/axios.js"}],"node_modules/axios-logger/lib/common/config.js":[function(require,module,exports) {
"use strict";
...
},{}],"node_modules/dateformat/lib/dateformat.js":[function(require,module,exports) {
var define;
var global = arguments[3];
/*
 * Date Format 1.2.3
...
},{}],"node_modules/axios-logger/node_modules/color-name/index.js":[function(require,module,exports) {
'use strict'
...
},{}],"node_modules/axios-logger/node_modules/color-convert/conversions.js":[function(require,module,exports) {
...
},{"color-name":"node_modules/axios-logger/node_modules/color-name/index.js"}],"node_modules/axios-logger/node_modules/color-convert/route.js":[function(require,module,exports) {
...
},{"./conversions":"node_modules/axios-logger/node_modules/color-convert/conversions.js"}],"node_modules/axios-logger/node_modules/color-convert/index.js":[function(require,module,exports) {
function _typeof(obj) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (obj) { return typeof obj; } : function (obj) { return obj && "function" == typeof Symbol && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }, _typeof(obj); }
...
},{"./conversions":"node_modules/axios-logger/node_modules/color-convert/conversions.js","./route":"node_modules/axios-logger/node_modules/color-convert/route.js"}],"node_modules/axios-logger/node_modules/ansi-styles/index.js":[function(require,module,exports) {
'use strict';
...
},{"color-convert":"node_modules/axios-logger/node_modules/color-convert/index.js"}],"node_modules/axios-logger/node_modules/supports-color/browser.js":[function(require,module,exports) {
'use strict';
...
},{}],"node_modules/axios-logger/node_modules/chalk/source/util.js":[function(require,module,exports) {
'use strict';
...
},{}],"node_modules/axios-logger/node_modules/chalk/source/templates.js":[function(require,module,exports) {
'use strict';
...
},{}],"node_modules/axios-logger/node_modules/chalk/source/index.js":[function(require,module,exports) {
'use strict';
...
},{"ansi-styles":"node_modules/axios-logger/node_modules/ansi-styles/index.js","supports-color":"node_modules/axios-logger/node_modules/supports-color/browser.js","./util":"node_modules/axios-logger/node_modules/chalk/source/util.js","./templates":"node_modules/axios-logger/node_modules/chalk/source/templates.js"}],"node_modules/axios-logger/lib/common/string-builder.js":[function(require,module,exports) {
"use strict";
...
},{"dateformat":"node_modules/dateformat/lib/dateformat.js","chalk":"node_modules/axios-logger/node_modules/chalk/source/index.js"}],"node_modules/axios-logger/lib/logger/request.js":[function(require,module,exports) {
"use strict";
...
},{"../common/config":"node_modules/axios-logger/lib/common/config.js","../common/string-builder":"node_modules/axios-logger/lib/common/string-builder.js"}],"node_modules/axios-logger/lib/logger/response.js":[function(require,module,exports) {
"use strict";
...
},{"../common/config":"node_modules/axios-logger/lib/common/config.js","../common/string-builder":"node_modules/axios-logger/lib/common/string-builder.js"}],"node_modules/axios-logger/lib/logger/error.js":[function(require,module,exports) {
"use strict";
...
},{"../common/config":"node_modules/axios-logger/lib/common/config.js","../common/string-builder":"node_modules/axios-logger/lib/common/string-builder.js"}],"node_modules/axios-logger/lib/index.js":[function(require,module,exports) {
"use strict";
...
},{"./common/config":"node_modules/axios-logger/lib/common/config.js","./logger/request":"node_modules/axios-logger/lib/logger/request.js","./logger/response":"node_modules/axios-logger/lib/logger/response.js","./logger/error":"node_modules/axios-logger/lib/logger/error.js"}],"lib/axios.js":[function(require,module,exports) {
"use strict";
...
var AxiosLogger = _interopRequireWildcard(require("axios-logger"));
...
var instance = _axios.default.create({
  ...
  headers: {
    "Content-Type": "application/json",
    "Authorization": _jsCookie.default.get('token'),
...
exports.default = _default;
},{"axios":"node_modules/axios/index.js","axios-logger":"node_modules/axios-logger/lib/index.js","js-cookie":"node_modules/js-cookie/dist/js.cookie.js"}],"index.js":[function(require,module,exports) {
"use strict";
...
var balance = document.querySelector('.balance_num');

function searchUrlCallback(response) {
  console.log("RESPONSE: " + response);
  var blocks = response; //JSON.parse(response.blocks).reverse();

  console.log(blocks.length);
  console.log("cookies: " + _jsCookie.default.get('nodeUrl') + "))");

  for (var key in blocks) {
    list.innerHTML += "<li>\n               <h6>".concat(blocks[key].index, "</h6>\n               <h6>").concat(blocks[key].timestamp, "</h6>  \n               <h6>").concat(blocks[key].data, "</h6>  \n                 ").concat(blocks[key].hash, " ");
    var trs = JSON.stringify(blocks[key].transactions);

    for (var t in trs) {
      list.innerHTML += "".concat(trs[t], " ");
    }
...
function searchURL() {
  var url = _jsCookie.default.get('nodeUrl') + '/' + 'blocks';
  console.log(url);
  requestURL = url;
  list.innerHTML = "";
  ...
  _axios.default.get(url, {
    ...
    return searchUrlCallback(data.blocks);
  }); // loadJSON('GET', url,
  //     function (response) {
...
searchURL();
console.log(_jsCookie.default.get('token') + " lskmlskmmmmrlk");

var getBalance = function getBalance() {
  var address = _jsCookie.default.get('nodeUrl');

  var url = _jsCookie.default.get('nodeUrl') + '/' + 'balance';
...
getBalance(); // window.location.replace("signin.html")
...
var popUpMenuButton = document.getElementById('pop_up_menu_button');
...
var openPopUpPeer = document.getElementById('open_pop_up_peer');
var closePopUpPeer = document.getElementById('pop_up_close_peer');
var popUpPeer = document.getElementById('pop_up_peer');
var userInputPeer = document.getElementById('username_peer');
var urlInputPeer = document.getElementById('url_peer');
var popUpMenuButtonPeer = document.getElementById('pop_up_menu_button_peer');
...
var openPopUpTransaction = document.getElementById('make_transaction');
var closePopUpTransaction = document.getElementById('pop_up_close_send');
var popUpTransaction = document.getElementById('pop_up_transaction');
var receiverInputTransaction = document.getElementById('receiver');
var amountInputTransaction = document.getElementById('amount');
var popUpMenuButtonTransaction = document.getElementById('pop_up_menu_button_send');
...
function addEventListenerToForm(button, inputOne, inputTwo, popUpOption, command) {
  button.addEventListener('click', function () {
    ...
    var url = _jsCookie.default.get('nodeUrl') + '/' + command;
...
function addEventListenerToMineForm(button, inputOne, inputTwo, popUpOption, command) {
  button.addEventListener('click', function () {
    var username = _jsCookie.default.get('nodeUrl');
    ...
    _axios.default.post(url, {
      ...
      return res.data;
    }).then(searchURL).catch(function (e) {
...
function addEventListenerToTransForm(button, inputOne, inputTwo, popUpOption, command) {
  button.addEventListener('click', function () {
    var receiver = inputOne.value;
    var amount = inputTwo.value;
    var url = _jsCookie.default.get('nodeUrl') + '/' + command;
    var currentDate = new Date();
    var body = {
      sender: _jsCookie.default.get('nodeUrl').trim(),
      receiver: receiver,
    ...
    _axios.default.post(url, {
      ...
      return console.log('[addEventListenerToTransForm]:', data);
    });
    /*
    loadJSON('POST',
        url,
...
},{"js-cookie":"node_modules/js-cookie/dist/js.cookie.js","./requests.js":"requests.js","./lib/axios":"lib/axios.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
...
//# sourceMappingURL=/blockchain-ui.e31bb0bc.js.map